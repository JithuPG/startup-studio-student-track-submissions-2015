<?php
class Compareimages extends CI_Controller {
	...
	{
		/*resizes the image to a 16x16 squere and returns as image resource*/
		$mime = $this->mimeType($source);
      
		$t = imagecreatetruecolor(16, 16);
		
		$source = $this->createImage($source);
		
		imagecopyresized($t, $source, 0, 0, 0, 0, 16, 16, $mime[0], $mime[1]);
    	...
    	private function colorMeanValue($i)
	{
		...
		return array($colorSum/256,$colorList);
	}
    	...
    	private function bits($colorMean)
	{
		...
		public function getimage()
		{
		  ...
		  $data['image'] = $this->compare($image1,$image2);
		  $data['image1'] = $image1;
		  $data['image2'] = $image2;
		  //echo $data;
		  $this->load->helper('url');
